          ...
          child: ListView(
            children: [
              ...
              Wrap(
                ...
                children: [
                  buildSample(label: 'linearRainbow', gradient: Foils.linearRainbow),
                  buildSample(
                    label: 'linearReversed',
                    gradient: Foils.linearReversed,
                  ),
                  buildSample(label: 'linearLooping', gradient: Foils.linearLooping),
                  buildSample(
                    label: 'linearLooping\nReversed',
                      ...
                      child: Row(
                        ...
                        children: [
                          Foil(
                            ...
                            child: TradingCard(
                              card: cards[1],
                              padding: const EdgeInsets.fromLTRB(100, 0, 80, 25),
                            ),
                          ),
                          Foil(
                            isUnwrapped: unwrapped,
                            ...
                            child: TradingCard(
                              card: cards[2],
                              padding: const EdgeInsets.fromLTRB(80, 0, 100, 25),
                            ),
                          ),
                        ],
                      ),
              ...
              Center(
                child: Foil.sheet(
                  isUnwrapped: unwrapped,
                  gradient: Foils.rainbow.copyWith(center: const Alignment(0, 0.6)),
                  ...
                  child: Align(
                    ...
                    child: Foil(
                      isUnwrapped: unwrapped,
                      gradient: Foils.rainbow.copyWith(radius: 1.5, center: const Alignment(0, 1.0)),
