...
extension GradientUtils on Gradient {
  ...
  /// a [AnimatedGradient.new] constructed by `this` gradient and the
  /// provided parameters.
  ///
  ...
  List<Color> get steppedColors => this is Steps ? (this as Steps).steppedColors : colors;

  /// If this is a [Steps]-type `Gradient`, returns `this.steppedStops`.
  /// Otherwise the fallback retrun value is [stops].
  List<double>? get steppedStops => this is Steps ? (this as Steps).steppedStops : stops;
