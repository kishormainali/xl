...
List<double> _quadruple(
  ...
  stops ??= List<double>.from(stopsOrImplied(stops, colors.length + 1))..removeLast();
  return stops % ShadeStep(distance, softness);
}

/// Construct a [LinearShadedSteps.new] that progresses from one color to the
...
class LinearShadedSteps extends LinearSteps {
  ...
  /// only duplicating.
  @override
  List<Color> get steppedColors => colors ^ Shade(function: shadeFunction, factor: shadeFactor);

  /// Overrides `Steps` property to "quadruplicate" with shading instead of
  /// only duplicating.
  @override
  List<double> get steppedStops => _quadruple(stops, colors, softness, distance);
  ...
  @override
  Gradient? lerpFrom(Gradient? a, double t) => (a == null || (a is LinearShadedSteps)) ? LinearShadedSteps.lerp(a as LinearShadedSteps?, this, t) : super.lerpFrom(a, t);

  @override
  Gradient? lerpTo(Gradient? b, double t) => (b == null || (b is LinearShadedSteps)) ? LinearShadedSteps.lerp(this, b as LinearShadedSteps?, t) : super.lerpTo(b, t);
  ...
  static Gradient? lerp(LinearShadedSteps? a, LinearShadedSteps? b, double t) {
    ...
    return LinearShadedSteps(
      ...
      shadeFactor: math.max(0.0, ui.lerpDouble(a.shadeFactor, b.shadeFactor.toDouble(), t)!),
  ...
  @override
  int get hashCode => hashValues(shadeFunction, shadeFactor, distance, softness, hashList(colors), hashList(stops), tileMode, begin, end);
...
/// Construct a [RadialShadedSteps.new] that progresses from one color to the
/// next in hard steps, each with its own intrinsic "shading," as opposed to
/// smooth transitions by way of "quadruplicating" colors and stops.
///
...
class RadialShadedSteps extends RadialSteps {
  ...
  @override
  Gradient? lerpFrom(Gradient? a, double t) => (a == null || (a is RadialShadedSteps)) ? RadialShadedSteps.lerp(a as RadialShadedSteps?, this, t) : super.lerpFrom(a, t);

  @override
  Gradient? lerpTo(Gradient? b, double t) => (b == null || (b is RadialShadedSteps)) ? RadialShadedSteps.lerp(this, b as RadialShadedSteps?, t) : super.lerpTo(b, t);
  ...
  /// Values for `t` are usually obtained from an [Animation<double>], such as
  /// an `AnimationController`.
  static RadialShadedSteps? lerp(RadialShadedSteps? a, RadialShadedSteps? b, double t) {
    if (a == null && b == null) return null;
    if (a == null) return b!.scale(t);
    if (b == null) return a.scale(1.0 - t);
    final stretched = PrimitiveGradient.fromStretchLerp(a, b, t);
  ...
  @override
  int get hashCode => hashValues(shadeFunction, shadeFactor, distance, softness, hashList(colors), hashList(stops), tileMode, center, radius, focal, focalRadius);
...
/// Construct a [SweepShadedSteps.new] that progresses from one color to the
/// next in hard steps, each with its own intrinsic "shading," as opposed to
/// smooth transitions by way of "quadruplicating" colors and stops.
///
...
class SweepShadedSteps extends SweepSteps {
  ...
  @override
  Gradient? lerpFrom(Gradient? a, double t) => (a == null || (a is SweepShadedSteps)) ? SweepShadedSteps.lerp(a as SweepShadedSteps?, this, t) : super.lerpFrom(a, t);

  @override
  Gradient? lerpTo(Gradient? b, double t) => (b == null || (b is SweepShadedSteps)) ? SweepShadedSteps.lerp(this, b as SweepShadedSteps?, t) : super.lerpTo(b, t);
  ...
  /// Values for `t` are usually obtained from an [Animation<double>], such as
  /// an `AnimationController`.
  static SweepShadedSteps? lerp(SweepShadedSteps? a, SweepShadedSteps? b, double t) {
    if (a == null && b == null) return null;
    if (a == null) return b!.scale(t);
    if (b == null) return a.scale(1.0 - t);
    final stretched = PrimitiveGradient.fromStretchLerp(a, b, t);
  ...
  @override
  int get hashCode => hashValues(shadeFunction, shadeFactor, distance, softness, hashList(colors), hashList(stops), tileMode, center, startAngle, endAngle);
