...
///
/// Use a [AnimatedGradient.new] and its [observe] property for [Gradient]-type
...
class AnimatedGradient extends AnimatedWidget {
  ...
  Gradient get observe {
    ...
    if (storyboard.containsKey(GradientAnimation.colorArithmetic)) {
      observation = _copyWith(observation,
          colors: _gradient.colors
              .map<Color>(
                (c) => (storyboard[GradientAnimation.colorArithmetic] as ColorArithmetic).call(c, animation.value),
              )
              .toList());
    }
    ...
    if (storyboard.containsKey(GradientAnimation.stopsArithmetic)) {
      observation = _copyWith(observation,
          stops: interpretStops(_gradient)
              .map<double>(
                (s) => (storyboard[GradientAnimation.stopsArithmetic] as StopsArithmetic).call(s, animation.value),
              )
              .toList());
    }
    ...
    final spec = storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>;
    return _copyWith(
      observation,
      begin: spec.containsKey(GradientProperty.begin) ? spec[GradientProperty.begin]!.evaluate(animation) : observation.begin,
      end: spec.containsKey(GradientProperty.end) ? spec[GradientProperty.end]!.evaluate(animation) : observation.end,
      center: spec.containsKey(GradientProperty.center) ? spec[GradientProperty.center]!.evaluate(animation) : observation.center,
      radius: spec.containsKey(GradientProperty.radius) ? spec[GradientProperty.radius]!.evaluate(animation) : observation.radius,
      focal: spec.containsKey(GradientProperty.focal) ? spec[GradientProperty.focal]!.evaluate(animation) : observation.focal,
      focalRadius: spec.containsKey(GradientProperty.focalRadius) ? spec[GradientProperty.focalRadius]!.evaluate(animation) : observation.focalRadius,
      startAngle: spec.containsKey(GradientProperty.startAngle) ? spec[GradientProperty.startAngle]!.evaluate(animation) : observation.startAngle,
      endAngle: spec.containsKey(GradientProperty.endAngle) ? spec[GradientProperty.endAngle]!.evaluate(animation) : observation.endAngle,
      softness: spec.containsKey(GradientProperty.softness) ? spec[GradientProperty.softness]!.evaluate(animation) : observation.softness,
      shadeFactor: spec.containsKey(GradientProperty.shadeFactor) ? spec[GradientProperty.shadeFactor]!.evaluate(animation) : observation.shadeFactor,
      distance: spec.containsKey(GradientProperty.distance) ? spec[GradientProperty.distance]!.evaluate(animation) : observation.distance,
    );
  }
  ...
  void _makeAssertations() {
    assert(
        storyboard.containsKey(GradientAnimation.colorArithmetic) ? storyboard[GradientAnimation.colorArithmetic]! is ColorArithmetic : true,
        'If [GradientAnimation.colorArithmetic] is employed, '
        'ensure the function value is a [ColorArithmetic].');
    assert(
        storyboard.containsKey(GradientAnimation.stopsArithmetic) ? storyboard[GradientAnimation.stopsArithmetic]! is StopsArithmetic : true,
    ...
    assert(
        storyboard.containsKey(GradientAnimation.tweenSpec)
            ...
            ? storyboard[GradientAnimation.tweenSpec]! is Map<GradientProperty, Tween<dynamic>>
            : true,
    ...
    if (storyboard.containsKey(GradientAnimation.tweenSpec)) {
      assert(
          ...
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.begin)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.begin]!
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.begin]! is Tween<AlignmentGeometry?>
              : true,
          'If [GradientProperty.begin] is employed, '
          'ensure the [tween] is a [Tween<AlignmentGeometry?>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.end)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.end]!
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.end]! is Tween<AlignmentGeometry?>
              : true,
          'If [GradientProperty.end] is employed, '
          'ensure the [tween] is a [Tween<AlignmentGeometry?>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.center)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.center]!
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.center]! is Tween<AlignmentGeometry?>
              : true,
          'If [GradientProperty.center] is employed, '
          'ensure the [tween] is a [Tween<AlignmentGeometry?>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.radius)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.radius]! is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.radius]! is Tween<double>
              : true,
          'If [GradientProperty.radius] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.focal)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.focal]!
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.focal]! is Tween<AlignmentGeometry?>
              : true,
          'If [GradientProperty.focal] is employed, '
          'ensure the [tween] is a [Tween<AlignmentGeometry?>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.focalRadius)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.focalRadius]!
                  //is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.focalRadius]! is Tween<double>
              : true,
          'If [GradientProperty.focalRadius] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.startAngle)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.startAngle]!
                  //is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.startAngle]! is Tween<double>
              : true,
          'If [GradientProperty.startAngle] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.endAngle)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.endAngle]! is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.endAngle]! is Tween<double>
              : true,
          'If [GradientProperty.endAngle] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.softness)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.softness]! is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.softness]! is Tween<double>
              : true,
          'If [GradientProperty.softness] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.shadeFactor)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.shadeFactor]! is Tween<num>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.shadeFactor]! is Tween<double>
              : true,
          'If [GradientProperty.shadeFactor] is employed, '
          'ensure the [tween] is a [Tween<double>].');
      assert(
          // (storyboard[GradientAnimation.tweenSpec] as TweenSpec)
          (storyboard[GradientAnimation.tweenSpec] as Map<GradientProperty, Tween<dynamic>>).containsKey(GradientProperty.distance)
              ? (storyboard[GradientAnimation.tweenSpec]
                  // as TweenSpec)[GradientProperty.distance]! is Tween<double>
                  as Map<GradientProperty, Tween<dynamic>>)[GradientProperty.distance]! is Tween<double>
              : true,
