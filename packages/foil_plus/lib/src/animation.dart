...
class AnimatedFoil extends ImplicitlyAnimatedWidget {
  ...
  @override
  ImplicitlyAnimatedWidgetState<ImplicitlyAnimatedWidget> createState() => _AnimatedFoilState();
}
...
class _AnimatedFoilState extends AnimatedWidgetBaseState<AnimatedFoil> {
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) =>
      _gradient = visitor(_gradient, widget.gradient, (dynamic value) => GradientTween(begin: value as Gradient, isAgressive: widget.isAgressive)) as GradientTween?;
...
class RolledOutFoil extends ImplicitlyAnimatedWidget {
  ...
  @override
  ImplicitlyAnimatedWidgetState<ImplicitlyAnimatedWidget> createState() => _RolledOutFoilState();
}
