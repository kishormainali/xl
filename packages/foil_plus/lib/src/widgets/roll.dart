...
class Roll extends StatefulWidget with Diagnosticable {
  ...
  static RollState? of(BuildContext context) => context.findAncestorStateOfType<RollState>();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty<Crinkle>('crinkle', crinkle, defaultValue: null))
...
class RollState extends State<Roll> with SingleTickerProviderStateMixin {
  ...
  bool get isSized => (context.findRenderObject() == null) ? false : (context.findRenderObject() as RenderBox).hasSize;
  ...
  Offset getDescendantOffset({
    ...
    Offset offset = Offset.zero,
      ...
      descendant.localToGlobal(offset, ancestor: context.findRenderObject() as RenderBox);
