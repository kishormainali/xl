...
class Foil extends StatefulWidget {
  ...
  ///
  /// Create a [Sheet.new] for parameter [sheet] to stylize the container.
  ///
  /// | ![unwrapping Foil](https://raw.githubusercontent.com/Zabadam/foil/master/doc/duration_tiny.gif) | Paramater `bool` [isUnwrapped] toggles a `Foil`'s invisibility. Default is `false.` |
  /// | :-: | :- |
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty<bool>('isUnwrapped', isUnwrapped, defaultValue: false))
      ..add(DiagnosticsProperty<bool>('useSensor', useSensor, defaultValue: true))
      ..add(DiagnosticsProperty<Scalar>('scalar', scalar, defaultValue: null))
      ..add(DiagnosticsProperty<BlendMode>('blendMode', blendMode, defaultValue: null))
      ..add(DiagnosticsProperty<Duration>('speed', speed, defaultValue: null))
      ..add(DiagnosticsProperty<Duration>('duration', duration, defaultValue: null))
      ..add(DiagnosticsProperty<Sheet>('sheet', sheet, defaultValue: null, ifNull: 'this is not a `Foil.sheet`'))
...
class _FoilState extends State<Foil> {
  ...
  Widget build(BuildContext context) {
    ...
    final isPortrait = (MediaQuery.maybeOf(context)?.orientation ?? Orientation.portrait) == Orientation.portrait;
    ...
    final effectiveGradient = widget.isUnwrapped ? widget.unwrappedGradient ?? gradient.asNill : gradient.scale(widget.opacity); // scale() controls overall opacity
