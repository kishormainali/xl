...
class Sheet with Diagnosticable {
  ...
  ///
  /// See also:
  /// - [Container.new], whose properties this `Sheet` mimics
  /// {@endtemplate}
  const Sheet({
    Color? color,
    this.width,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty<EdgeInsetsGeometry>('margin', margin, defaultValue: false))
      ..add(DiagnosticsProperty<EdgeInsetsGeometry>('padding', padding, defaultValue: false))
      ..add(DiagnosticsProperty<AlignmentGeometry>('alignment', alignment, defaultValue: false))
      ..add(DiagnosticsProperty<Decoration>('decoration', decoration, defaultValue: false))
      ..add(DiagnosticsProperty<Decoration>('foregroundDecoration', foregroundDecoration, defaultValue: false))
      ..add(DiagnosticsProperty<Clip>('clipBehavior', clipBehavior, defaultValue: false))
      ..add(DiagnosticsProperty<BoxConstraints>('constraints', constraints, defaultValue: false))
      ..add(DiagnosticsProperty<Matrix4>('transform', transform, defaultValue: false))
      ..add(DiagnosticsProperty<AlignmentGeometry>('transformAlignment', transformAlignment, defaultValue: false));
  }
}
